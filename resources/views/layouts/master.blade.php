	   ...
	   <ul class="collapsible">
		  <li>
		    ...
		    @foreach($invitations as $invitation)
		       <p>
		       	<span class="red-text"><b>{{ $invitation->friend->name }}</b> <a href="{{ route('acceptInvitation',['id'=>$invitation->id]) }}">accept</a> | 
		       	<a href="{{ route('denyInvitation',['id'=>$invitation->id]) }}">deny</a></span>
		       </p>	
		     @endforeach	      
		    </div>
		  </li>		  
